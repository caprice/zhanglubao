...
import com.zhanglubao.lol.fragment.CachingFragment;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by rocks on 15-7-5.
 */
public class CachePagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CachePagerAdapter(FragmentManager fragmentManager,
                             ViewPager viewPager, CachedFragment cachedFragment, CachingFragment cachingFragment) {
        this.cachedFragment = cachedFragment;
        this.cachingFragment = cachingFragment;
        this.fragments.add(cachedFragment);
        this.fragments.add(cachingFragment);
