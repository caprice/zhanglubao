<?php if (!defined('THINK_PATH')) exit();?><div class="col4 mod_board">
	<div class="col2">
		<div class="pack_focus">
			<div class="pic">
				<a href="<?php echo ($foucs["rec_url"]); ?>" title="<?php echo ($foucs["rec_title"]); ?>" target="new"></a> <img class="quic"
			...
			<div class="pack packs">
				...
				<div class="pic">
					<a href="<?php echo ($rec_eight['rec_url']); ?>"
						title="<?php echo ($rec_eight['rec_title']); ?>" target="new"></a> <img
			...
			<div class="pack packs">
				...
				<div class="pic">
					<a href="<?php echo ($rec_seven['rec_url']); ?>"
						title="<?php echo ($rec_seven['rec_title']); ?>" target="new"></a> <img
						class="quic" src="/Public/Static/images/placeholder.png"
