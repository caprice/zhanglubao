...
<link href="/Public/Team/css/album.css" rel="stylesheet" />
</head>
<body>
			...
			<div class="col-xs-9">
				<div class="row">
					...
					<div class="col-xs-12">
							...
							<div class="pull-left team-info">
								...
								<div class="team-navs">
									...
									<a id="nav-video" class="team-nav"
										...
										id="nav-album" class="team-nav team-nav-current"
										href="<?php echo U('/team/album/'.$teamid);?>">专辑</a> <a id="nav-album"
										class="team-nav" href="<?php echo U('/team/match/'.$teamid);?>">比赛</a>
								</div>
							</div>
						...
						<?php if($_list): ?><div class="column-content">
