...
<script type="text/javascript" src="/Public/Team/js/index.js"></script>
<link href="/Public/Team/css/index.css" rel="stylesheet" />
</head>
<body>
...
<a id="goTopBtn"></a>
	<div id="main-container" class="container">
		<div class="row">
			...
			<div class="col-xs-9">
				<div class="row"> 
				<?php echo W('IndexAd/lists');?>
				<?php echo W('IndexGames/lists');?>
				<?php echo W('IndexTeam/lists');?>
				<?php echo W('IndexVideo/lists');?>
				<?php echo W('IndexForum/lists');?>
				</div>
			</div>
			<!-- 右边 -->
			<div class="col-xs-3">
