				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<?php if($list_top): ?><div class="fourm-posts common_block_border">
							...
							<div class="col-xs-12">
								<section id="contents">
									<?php if(is_array($list_top)): $i = 0; $__LIST__ = $list_top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$document): $mod = ($i % 2 );++$i; $user = query_user(array('avatar','username','uid'), $document['uid']); ?>
									<div class="row">
										<div class="col-md-2 col-xs-4 text-center">
											<p>
												<a href="<?php echo U('/u/'.$user['uid']);?>"> <img
													src="<?php echo ($user["avatar"]); ?>" width='64px' height='64px'
													ucard="<?php echo ($user["uid"]); ?>" class="avatar-img" />
												</a>
											</p>
										</div>
										<div class="col-md-10 col-xs-12">
											...
											<p>
												<a class="forum-list-title-link"
													...
													href="<?php echo U('/Team/Forum/detail',array('id'=>$document['id']));?>"><?php echo (mb_substr(htmlspecialchars($document["title"]),0,30,'utf-8')); ?>
												</a>

											</p>

											<p class="pull-right text-muted">
												<span>阅读（<?php echo ($document["view_count"]); ?>）</span> <span
													style="width: 1em; display: inline-block;">&nbsp;</span> <span>回复（<?php echo ($document["reply_count"]); ?>）</span>
											</p>
						...
						<div class="fourm-posts common_block_border">
								...
								<div class="pull-right text-right" style="margin-right: 15px">
									<div class="btn-group forum_order">
										<button type="button" class="btn btn-primary dropdown-toggle"
											...
											<?php if(($order) == "0"): ?>回复时间<?php else: ?>发表时间<?php endif; ?>
											<span class="caret"></span>
										</button>
										<ul class="dropdown-menu text-left" role="menu">
											<li><a
												href="<?php echo U('forum',array('id'=>$forum_id,'order'=>'ctime'));?>">发表时间</a></li>
											<li><a
												href="<?php echo U('forum',array('id'=>$forum_id,'order'=>'reply'));?>">回复时间</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								<section id="contents">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$document): $mod = ($i % 2 );++$i; $user = query_user(array('avatar','username','uid'), $document['uid']); ?>
									<div class="row">
										<div class="col-md-2 col-xs-4 text-center">
											<p>
												<a href="<?php echo U('/u/'.$user['uid']);?>"> <img
									...
									<?php else: ?>
									<div class="forum-list-no-hr"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
									<div class="pull-right"><?php echo getPagination($totalCount);?></div>
								</section>
							</div>
						</div>
