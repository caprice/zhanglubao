...
<link href="/Public/Team/css/listview.css" rel="stylesheet" />
</head>
<body>
					...
					<div class="col-xs-12">
						...
						<div class="column-content">
							<div class="game-category-area">
								<ul>
									<?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$game): $mod = ($i % 2 );++$i;?><li <?php if($game['id'] == $gameid): ?>class="selected"<?php endif; ?>><a href="<?php echo U('/team/list/'.$game['id']);?>"
						...
						<div class="team-list column-content">
							<ul>
								<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$team): $mod = ($i % 2 );++$i;?><li>
									<div class="cl">
										<div class="team-icon">

											<a href="<?php echo U('/team/'.$team['id']);?>"> <img
												src="/Public/Core/images/placeholder.png"
												lazy-src="<?php echo (get_cover($team["cover"],url)); ?>" width="80"
												height="80">
											</a>
										</div>
										<div class="team-info">
											...
											<div>
												<a href="<?php echo U('/team/'.$team['id']);?>"><?php echo ($team["name"]); ?></a>
											</div>
