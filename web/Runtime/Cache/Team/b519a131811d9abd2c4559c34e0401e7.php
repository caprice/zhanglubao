...
<link href="/Public/Team/css/view.css" rel="stylesheet" />
</head>
<body>
					...
					<div class="col-xs-12">
						<div class="team-info">
							...
							<div class="pull-left team-info">
								...
								<div class="team-navs">
									<a id="nav-home" class="team-nav team-nav-current"
										href="<?php echo U('/team/'.$teamid);?>">首页</a> <a id="nav-video"
										class="team-nav" href="<?php echo U('/team/video/'.$teamid);?>">视频</a> <a
						...
						<div class="member-list column-content">
							<ul>
								<?php if(is_array($members)): $i = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$member): $mod = ($i % 2 );++$i;?><li>
									<div class="member-avatar">
										<a href="<?php echo U('/u/'.$member['uid']);?>"><img
											src="/Public/Core/images/placeholder.png"
											lazy-src="<?php echo ($member['avatar']); ?>" width="68" height="68"></a>
									</div>
									<div class="member-info">
										<div class="">
											<a href="<?php echo U('/u/'.$member['uid']);?>"><?php echo ($member["username"]); ?></a>
										</div>
										<div class=""><?php echo ($member["place"]); ?></div>
										<div class=""><?php echo ($member["hero"]); ?></div>
									</div>
								</li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>

						<?php if($videos): if($members): ?><div class="column-content">
							<div class="column-content-title">
								<i class="title-tip-box"></i> <span class="title-tip"><a
									href="<?php echo U('/team/video/'.$team['id']);?>">最新比赛视频</a></span> <span
									class="pull-right"> <a
									href="<?php echo U('/team/video/'.$team['id']);?>">更多视频</a></span>
							</div>
						</div><?php endif; ?>
						...
						<?php if($posts): ?><div class="column-content">
							<div class="column-content-title">
								<i class="title-tip-box"></i> <span class="title-tip"><a
									href="<?php echo U('/team/forum/'.$team['id']);?>">最新话题</a></span> <span
									class="pull-right"> <a
									href="<?php echo U('/team/forum/'.$team['id']);?>">更多话题</a></span>
							</div>
						</div>
						<div class="column-content">
							<div class="forum-list">
								<ul>
									<?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$post): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('/Team/Forum/detail/id/'.$post['id']);?>"> <span
											class="pull-left"><?php echo ($post["title"]); ?></span><span
											class="pull-right"><?php echo ($post["forum_name"]); ?></span>
