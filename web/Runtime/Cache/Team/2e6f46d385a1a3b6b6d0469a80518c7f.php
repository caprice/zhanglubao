				...
				<div class="row">
					...
					<div class="col-xs-12">
							...
							<div class="pull-left team-info">
								...
								<div class="team-navs">
									...
									<a id="nav-video" class="team-nav"
										...
										href="<?php echo U('/team/forum/'.$teamid);?>">贴吧</a> <a id="nav-album"
						...
						<?php if($list_top): ?><div class="fourm-posts common_block_border">
							...
							<div class="col-xs-12">
								<section id="contents">
									<?php if(is_array($list_top)): $i = 0; $__LIST__ = $list_top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$document): $mod = ($i % 2 );++$i; if($i != count($list_top)): ?><hr class="forum-list-hr" />
									<?php else: ?>
						...
						<div class="fourm-posts common_block_border">
							...
							<div class="col-xs-12">
								<section id="contents">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$document): $mod = ($i % 2 );++$i; if($i != count($list)): ?><hr class="forum-list-hr" />
									<?php else: ?>
									<div class="forum-list-no-hr"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
