				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div class="fourm-top common_block_border"
							...
							<h4>
								<?php if($isEdit): ?>编辑帖子 <?php else: ?> 发表新帖<?php endif; ?>
							</h4>
							<hr />
							<section id="contents">
								<form action="<?php echo U('Team/Forum/doEdit');?>" method="post"
									...
									<p>
                                       ...
                                       style="width:100%; height: 8em;"><?php echo (htmlspecialchars($post["content"])); ?></textarea>-->


										<?php echo W('ForumUeditorMini/editor',array('contentEditor','content',$post['content'],'100%','250px',$config));?>
									...
									<p class="pull-right">
										<button type="submit" class="btn btn-large btn-primary"
											...
											<span class="glyphicon glyphicon-edit"></span> <span
												id="submit-content"> <?php if($isEdit): ?>编辑帖子 Ctrl+Enter <?php else: ?> 发表帖子 Ctrl+Enter<?php endif; ?>
											</span>
										</button>
...
<div class="hidden">
 ...
 <script type="text/javascript"
	src="/Public/Core/js/ext/atwho/atwho.js"></script>
<link type="text/css" rel="stylesheet"
	href="/Public/Core/js/ext/atwho//atwho.css" />
<script>
	//点击编辑或发表按钮之后
	$(function() {
