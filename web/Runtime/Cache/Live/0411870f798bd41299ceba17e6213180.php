...
<link href="/Public/Live/css/listview.css" rel="stylesheet" />
</head>
<body>
		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<div class="column-content-title">
							<i class="title-tip-box"></i> <span class="title-tip"><?php echo get_game($gameid,'title');?></span>
					...
					<div class="col-xs-12  column-content">
						<div class="live-list">
							<ul>
								<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$live): $mod = ($i % 2 );++$i;?><li>
									...
									<div class="live-des">
										<span class="pull-left"> <span
											...
											class="pull-right ">
											<?php echo get_game($live['game_id'],'title');?> </span>
									</div>
			...
			<div class="col-xs-3">
				<div>
					...
					<?php echo W('ListHotAnchors/lists',array($gameid));?>


					<?php echo W('ListNewAnchors/lists',array($gameid));?>
