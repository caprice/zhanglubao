...
<div class="fl"><a class="btn"
	href="<?php echo U('MatchGameDetail/add?matchgameid='.$matchgameid);?>">新 增</a>
<button class="btn ajax-post confirm"
	url="<?php echo U('MatchGameDetail/changeStatus',array('method'=>'deleteMatchGameDetail'));?>"
...
<table class="">
	...
	<tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["blue_team"]); ?></td>
			<td><?php echo ($vo["red_team"]); ?></td>
			<td><?php echo ($vo["game_order"]); ?></td>
			<td><?php echo query_team('name',$vo['winner']);?></td>
			<td><?php echo ($vo["status"]); ?></td>
			<td>
			  <a
				href="<?php echo U('MatchGameDetail/edit?id='.$vo['id'].'&&matchagemid='.$matchgameid);?>" class="authorize">编辑</a>
			<a
				href="<?php echo U('MatchGameDetail/delete?id='.$vo['id'].'&&matchgameid='.$matchgameid);?>"
