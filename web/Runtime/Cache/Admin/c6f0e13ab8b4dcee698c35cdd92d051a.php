...
<h2><?php echo isset($ad['id'])?'编辑':'新增';?>广告</h2>
</div>
...
<div class="controls"><input type="text" class="text input-large"
	name="title" value="<?php echo ((isset($ad["title"]) && ($ad["title"] !== ""))?($ad["title"]):''); ?>"></div>
</div>
<div class="form-item"><label class="item-label">广告跳转地址<span
	class="check-tips">（广告跳转地址）</span></label>
<div class="controls"><input type="text" class="text input-large"
	name="url" value="<?php echo ((isset($ad["url"]) && ($ad["url"] !== ""))?($ad["url"]):''); ?>"></div>
</div>

<div class="form-item"><label class="item-label">广告顺序<span
	class="check-tips">（广告顺序）</span></label>
<div class="controls"><input type="text" class="text input-large"
	name="display_order" value="<?php echo ((isset($ad["display_order"]) && ($ad["display_order"] !== ""))?($ad["display_order"]):''); ?>"></div>
</div>
...
<div class="controls"><select name="place">
	...
	<option value="0" <?php if(($ad['place']) == "0"): ?>selected<?php endif; ?>>切换广告</option>
	<option value="1" <?php if(($ad['place']) == "1"): ?>selected<?php endif; ?>>专辑广告</option>
	<option value="2" <?php if(($ad['place']) == "2"): ?>selected<?php endif; ?>>其他广告</option>
</select></div>
</div>
...
<div class="controls"><select name="module">
	<option value="home" <?php if(($$ad['module']) == "home"): ?>selected<?php endif; ?>>主页</option>
	<option value="competition" <?php if(($ad['module']) == "competition"): ?>selected<?php endif; ?>>比赛</option>
	<option value="guess" <?php if(($ad['module']) == "guess"): ?>selected<?php endif; ?>>竞猜</option>
	<option value="fight" <?php if(($ad['module']) == "fight"): ?>selected<?php endif; ?>>约战</option>
	<option value="live" <?php if(($ad['module']) == "live"): ?>selected<?php endif; ?>>直播</option>
	<option value="video" <?php if(($ad['module']) == "video"): ?>selected<?php endif; ?>>视频</option>
	<option value="team" <?php if(($ad['module']) == "team"): ?>selected<?php endif; ?>>战队</option>
</select></div>
</div>
...
<div class="form-item"><label class="item-label">广告图腾</label> <input
	...
	name="cover" id="cover" value="<?php echo ((isset($ad['cover']) && ($ad['cover'] !== ""))?($ad['cover']):''); ?>" />
<div class="upload-img-box"><?php if(!empty($ad['cover'])): ?><div class="upload-pre-item"><img
	src="<?php echo (get_cover($ad["cover"],'url')); ?>" /></div><?php endif; ?></div>
</div>
<script type="text/javascript">
					//上传图片
				    /* 初始化上传插件 */
					$("#upload_picture").uploadify({
				        ...
				        "buttonText"      : "上传图片",
				        "uploader"        : "<?php echo U('File/uploadAdPic',array('session_id'=>session_id()));?>",
				        "width"           : 120,
				        'removeTimeout'	  : 1,
...
<textarea name="description"><?php echo ((isset($ad["description"]) && ($ad["description"] !== ""))?($ad["description"]):''); ?></textarea> </label></div>
</div>
<div class="form-item"><input type="hidden" name="id"
	value="<?php echo ((isset($ad["id"]) && ($ad["id"] !== ""))?($ad["id"]):''); ?>">
