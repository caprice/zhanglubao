...
<div class="cf">
<div class="fl"><a class="btn" href="<?php echo U('Series/add');?>">新 增</a>
<button class="btn ajax-post confirm"
	url="<?php echo U('Series/changeStatus',array('method'=>'deleteSeries'));?>"
...
<table class="">
	...
	<tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Match/add?seriesid='.$vo['id']);?>">添加赛季</a>


			<?php if(($vo["status"]) == "1"): ?><a
				href="<?php echo U('Series/changeStatus?method=forbidSeries&id='.$vo['id']);?>"
				class="ajax-get">禁用</a> <?php else: ?> <a
				href="<?php echo U('Series/changeStatus?method=resumeSeries&id='.$vo['id']);?>"
				class="ajax-get">启用</a><?php endif; ?> <a href="<?php echo U('Series/edit?id='.$vo['id']);?>"
				class="authorize">编辑</a> <a
				href="<?php echo U('Series/changeStatus?method=deleteSeries&id='.$vo['id']);?>"
