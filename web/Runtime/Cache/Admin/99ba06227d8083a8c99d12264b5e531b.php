...
<div class="cf">
<div class="fl"><a class="btn" href="<?php echo U('Match/add');?>">新 增</a>
<button class="btn ajax-post confirm"
	url="<?php echo U('Match/changeStatus',array('method'=>'deleteMatch'));?>"
...
<table class="">
	...
	<tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Match/addVideo?matchid='.$vo['id']);?>">添加视频</a>
			<a href="<?php echo U('MatchGame/index?matchid='.$vo['id']);?>">小组赛</a>
			<?php if(($vo["status"]) == "1"): ?><a
				href="<?php echo U('Match/changeStatus?method=forbidMatch&id='.$vo['id']);?>"
				class="ajax-get">禁用</a> <?php else: ?> <a
				href="<?php echo U('Match/changeStatus?method=resumeMatch&id='.$vo['id']);?>"
				class="ajax-get">启用</a><?php endif; ?> <a href="<?php echo U('Match/edit?id='.$vo['id']);?>"
				class="authorize">编辑</a> <a
				href="<?php echo U('Match/changeStatus?method=deleteMatch&id='.$vo['id']);?>"
