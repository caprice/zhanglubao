...
<h2><?php echo isset($matchgame['id'])?'编辑':'新增';?>视频</h2>
</div>
...
<div class="controls"><input type="text" class="text input-large"
	name="video_id" value="<?php echo ((isset($matchvideo["video_id"]) && ($matchvideo["video_id"] !== ""))?($matchvideo["video_id"]):''); ?>"></div>
</div>


<div class="form-item"><input type="hidden" name="id"
	value="<?php echo ((isset($matchgame["id"]) && ($matchgame["id"] !== ""))?($matchgame["id"]):''); ?>"> 
	...
	<input type="hidden" name="match_game_id"
	value="<?php echo ((isset($matchgame["id"]) && ($matchgame["id"] !== ""))?($matchgame["id"]):''); ?>">
	
	<?php if($matchgame): ?><input type="hidden" name="match_id"
