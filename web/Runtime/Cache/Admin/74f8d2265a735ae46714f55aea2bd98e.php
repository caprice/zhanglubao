...
<h2><?php echo isset($matchgamedetail['id'])?'编辑':'新增';?>场次结果</h2>
</div>
...
<div class="form-item"><label class="item-label">场序<span
	class="check-tips">场序</span></label>
<div class="controls"><input type="text" class="text input-large"
	name="game_order" value="<?php echo ((isset($matchgamedetail["game_order"]) && ($matchgamedetail["game_order"] !== ""))?($matchgamedetail["game_order"]):'0'); ?>"></div>
</div>
...
<select name="winner"/>
<option value="<?php echo ($matchgame["red_team"]); ?>"<?php if(($matchgame['red_team']) == $matchgamedetail["winner"]): ?>selected<?php endif; ?>><?php echo query_team('name',$matchgame['red_team']);?></option>
		
		
<option value="<?php echo ($matchgame["blue_team"]); ?>"<?php if(($matchgame['blue_team']) == $matchgamedetail["winner"]): ?>selected<?php endif; ?>><?php echo query_team('name',$matchgame['blue_team']);?></option>		
		
</select>
 </div>
</div>

<div class="form-item"><label class="item-label">蓝队结果:<?php echo query_team('name',$matchgame['blue_team']);?><span
	class="check-tips">蓝队结果</span></label>
<div class="controls"><input type="text" class="text input-large"
	name="blue_team" value="<?php echo ((isset($matchgamedetail["blue_team"]) && ($matchgamedetail["blue_team"] !== ""))?($matchgamedetail["blue_team"]):'0'); ?>"></div>
</div>


<div class="form-item"><label class="item-label">红队结果:<?php echo query_team('name',$matchgame['red_team']);?><span
	class="check-tips">红队结果</span></label>
<div class="controls"><input type="text" class="text input-large"
	name="red_team" value="<?php echo ((isset($matchgamedetail["red_team"]) && ($matchgamedetail["red_team"] !== ""))?($matchgamedetail["red_team"]):'0'); ?>"></div>
</div>
...
<div class="controls"><input type="text" class="text input-large"
	name="video_id" value="<?php echo ((isset($matchgamedetail["video_id"]) && ($matchgamedetail["video_id"] !== ""))?($matchgamedetail["video_id"]):'0'); ?>"></div>
</div>


<div class="form-item"><input type="hidden" name="id"
	value="<?php echo ((isset($matchgamedetail["id"]) && ($matchgamedetail["id"] !== ""))?($matchgamedetail["id"]):''); ?>"> <?php if($matchgamedetail): ?><input type="hidden" name="match_game_id"
	value="<?php echo ((isset($matchgamedetail["match_game_id"]) && ($matchgamedetail["match_game_id"] !== ""))?($matchgamedetail["match_game_id"]):''); ?>"> <?php else: ?> <input
	type="hidden" name="match_game_id" value="<?php echo ($match_game_id); ?>"><?php endif; ?>
	
		<input type="hidden" name="match_id"
	value="<?php echo ((isset($matchgame["match_id"]) && ($matchgame["match_id"] !== ""))?($matchgame["match_id"]):''); ?>"> 
	
	
	<input type="hidden" name="blue_team_id"
	value="<?php echo ((isset($matchgame["blue_team"]) && ($matchgame["blue_team"] !== ""))?($matchgame["blue_team"]):''); ?>"> 
	
	<input type="hidden" name="red_team_id"
	value="<?php echo ((isset($matchgame["red_team"]) && ($matchgame["red_team"] !== ""))?($matchgame["red_team"]):''); ?>"> 
