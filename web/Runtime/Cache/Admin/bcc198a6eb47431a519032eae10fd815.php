...
<div class="fl"><a class="btn"
	href="<?php echo U('MatchGame/add?matchid='.$matchid);?>">新 增</a>
<button class="btn ajax-post confirm"
	url="<?php echo U('MatchGame/changeStatus',array('method'=>'deleteMatchGame'));?>"
...
<div class="sleft"><input type="text" name="nickname"
	class="search-input" value="<?php echo I('nickname');?>" placeholder="团队名称或者ID">
<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('index');?>"><i
...
<?php if($vo['blue_team'] != '0'): ?><td><?php echo get_team($vo['blue_team'],'name');?></td
			><?php else: ?>
			<td>弃权</td><?php endif; ?>

			<?php if($vo['red_team'] != '0'): ?><td><?php echo get_team($vo['red_team'],'name');?></td>
			<?php else: ?>
			<td>弃权</td><?php endif; ?>
			<td><?php echo date('Y-m-d H:i:s',$vo['start_time']);?></td>
			<td><?php echo ($vo["round"]); ?></td>
			<td><?php echo ($vo["winner"]); ?></td>
			<td><?php echo ($vo["game_status"]); ?></td>
			<td><?php echo ($vo["status"]); ?></td>
			<td>
		 	<a href="<?php echo U('MatchGame/addVideo?matchgameid='.$vo['id']);?>">添加视频</a>
			 <a
				href="<?php echo U('MatchGameDetail/index?matchgameid='.$vo['id']);?>">添加场次</a>
			
			<?php if(($vo["status"]) == "1"): ?><a
				href="<?php echo U('MatchGame/changeStatus?method=forbidMatchGame&id='.$vo['id']);?>"
				class="ajax-get">禁用</a> <?php else: ?> <a
				href="<?php echo U('MatchGame/changeStatus?method=resumeMatchGame&id='.$vo['id']);?>"
				class="ajax-get">启用</a><?php endif; ?> <a
				href="<?php echo U('MatchGame/edit?id='.$vo['id']);?>" class="authorize">编辑</a>
			<a
				href="<?php echo U('MatchGame/changeStatus?method=deleteMatchGame&id='.$vo['id']);?>"
