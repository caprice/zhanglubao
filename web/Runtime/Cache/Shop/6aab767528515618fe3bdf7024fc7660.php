	...
	<div class="shop">
		...
		<div class="col-md-12  app_block clearfix">
			<div class="row pad_15">
						...
						<dl>
							<dt>
								<a href="<?php echo U('Shop/Index/goodsDetail',array('id'=>$vo['id']));?>">
									<img  
									src="<?php echo query_picture('url',$vo['goods_ico']);?>" height="150px"
									width="222px">
								</a>
							</dt>
							<dd>
								<div class="left" style="width: 140px">
									<a class="text-more color_33"
										...
										style="width: 100%;"> <font title="<?php echo (op_t($vo["goods_name"])); ?>"><?php echo ($vo["goods_name"]); ?></font>
									</a>
								</div>
								<div class="right" style="color: #d61f39;">
									<a><font title="所需<?php echo ($quntiao_money_name); ?>"><i
											class="ico_to_money"></i>&nbsp;<?php echo ($vo["quntiao_money_need"]); ?></font></a>
								</div>
							...
							<dd class="color_84 font_s_14">
								...
								<div class="right">
									<a href="#frm-post-popup" class="<?php echo ($class); ?> btn exchange_goods"
										style="border: 1px solid #E0DBDB" goods_id="<?php echo ($vo['id']); ?>">兑&nbsp;&nbsp;换</a>
								</div>
							</dd>
							<div class="clearfix"></div>
						</dl>
				...
				<?php if(count($contents_new) == 0): ?><div
					style="font-size: 3em; padding: 2em 0; color: #ccc; text-align: center">现在还没有新品哦。O(∩_∩)O~</div><?php endif; ?>
			</div>
			<div class="row pad_15">
				...
				<?php if(count($contents_hot) == 0): ?><div
	...
	<div id="frm-post-popup" class="white-popup mfp-hide"
		...
		<div class="row">
			<form class="form-horizontal  ajax-form" role="form"
				action="<?php echo U('Shop/Index/goodsBuy');?>" method="post">
				<input type="hidden" id="goods_id" name="id" value=""> <input
					type="hidden" name="address_id" value="<?php echo ($shop_address['id']); ?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-10" style="width: 60%">
						<textarea id="address" name="address" class="form-control"
							placeholder="收货地址" style="max-width: 310px"><?php echo ($shop_address['address']); ?></textarea>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10" style="width: 60%">
						<input id="zipcode" name="zipcode" type="text"
							class="form-control" value="<?php echo ($shop_address['zipcode']); ?>"
							placeholder="邮编" />
					</div>
				</div>
				<div class="form-group">
...
<input type="hidden" id="quntiao_money_name"
	value="<?php echo ($quntiao_money_name); ?>" /> 
</div>
...
<link type="text/css" rel="stylesheet"
	href="/Public/Core/js/ext/magnific/magnific-popup.css" />
<script type="text/javascript"
	src="/Public/Static/uploadify/jquery.uploadify.min.js"></script> <script
