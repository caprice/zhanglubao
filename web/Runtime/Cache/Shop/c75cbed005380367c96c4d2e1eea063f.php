	...
	<div class="shop">
		<nav class="shop_navbar" role="navigation">
			...
			<div>
				<ul class="shop-nav">
					...
					<li><a href="<?php echo U('goods');?>" <?php if($category_id == 0): ?>class="current"<?php endif; ?>>所有分类</a></li>
					<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i; if($top['status'] == 1): ?><li><a href="<?php echo U('goods',array('category_id'=>$top['id']));?>" <?php if($category_id == $top['id']): ?>class="current"<?php endif; ?>><?php echo ($top["title"]); ?></a>
            ...
            <div class="col-md-12  app_block clearfix">
                <div class="row pad_15">
                    <?php if($top_category == ''): ?><h2 class="title_content">所有商品</h2>
                        <?php else: ?>
                    ...
                    <?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-3 col-md-4  goods">
                            <div class="item_goods position_re">
                                <?php if($vo['sell_num'] >= $hot_num): ?><i class="ico_hot"></i>
                                    <?php else: ?>
                                    <?php if($vo['is_new'] == 1): ?><i class="ico_new"></i><?php endif; endif; ?>
                                <dl>
                                    <dt>
                                        ...
                                        <img class="img-responsive" src="<?php echo query_picture('url',$vo['goods_ico']);?>" height="150px" width="222px">
                                        </a>
                                    </dt>
                                    <dd>
                                        ...
                                        <div class="right" style="color: #d61f39;"><a><font title="所需<?php echo ($quntiao_money_name); ?>"><i
                                                class="ico_to_money"></i>&nbsp;<?php echo ($vo["quntiao_money_need"]); ?></font></a></div>
                    ...
                    <?php if(count($contents) == 0): ?><div style="font-size:3em;padding:2em 0;color: #ccc;text-align: center">该分类下现在还没有商品哦。O(∩_∩)O~
                        </div><?php endif; ?>
                </div>
            </div>
        ...
        <?php if(is_login()): ?><!-- Modal -->
            <div id="frm-post-popup" class="white-popup mfp-hide" style="max-width: 500px;">
                ...
                <div class="row">
                    <form class="form-horizontal  ajax-form" role="form" action="<?php echo U('Shop/Index/goodsBuy');?>"
                          method="post">
