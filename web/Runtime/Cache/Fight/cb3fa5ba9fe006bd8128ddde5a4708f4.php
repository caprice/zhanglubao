...
<script type="text/javascript" src="/Public/Fight/js/index.js"></script>
<link href="/Public/Fight/css/index.css" rel="stylesheet" />
</head>
<body>
		...
		<div class="row">
			...
			<div class="col-xs-9">
				<div class="row"><?php echo W('IndexAd/lists');?>
					...
					<?php echo W('IndexGames/lists');?> <?php echo W('IndexLol/lists');?>
					<?php echo W('IndexFights/lists');?></div>
			</div>
			<!-- 右边 -->
			<div class="col-xs-3">
				<div>
					...
					<?php echo W('IndexFightRank/lists');?> <?php echo W('IndexMatches/lists');?>
