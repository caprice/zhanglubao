...
<link href="/Public/Fight/css/view.css" rel="stylesheet" />
</head>
<body>
			...
			<div class="col-xs-9">
				...
				<div class="vs-title-info">
					<i class="vs-title-tip-box"></i> <span class="vs-title-tip">
						<span class="title-content"> <span class="match-name"><?php echo date('Y-m-d H:i',$fight['start_time']);?></span>
							<span class="match-game-title"><h3>
									<a href="<?php echo U('/u/'.$fight['host_uid']);?>"><?php echo ($fight['host']['username']); ?></a>
									<?php if($fight['guest']): ?><b>vs</b> <a
										href="<?php echo U('/u/'.$fight['guest_uid']);?>"><?php echo ($fight['guest']['username']); ?></a><?php endif; ?>


								</h3></span> <span class="match-game-category"> <a
								href="<?php echo U('/fight/list/'.$fight['game_id']);?>"><?php echo get_game($fight['game_id'],'title');?>-<?php echo ($fight["game_area"]); ?></a>
						</span>
					</span>
				</div>
				...
				<div class="fight-area">
					<div class="fight-member">
						<a href="<?php echo U('/fight/'.$fight['id']);?>"><img
							...
							lazy-src="<?php echo ($fight['host']['avatar']); ?>" width="150" height="150"></a>
					</div>
					<div class="fight-member vs">VS</div>
					<div class="fight-member">

						<?php if($fight['guest']): ?><div class="blue_team">
							<a href="<?php echo U('/fight/'.$fight['id']);?>"><img
								src="/Public/Core/images/placeholder.png"
								lazy-src="<?php echo ($fight['guest']['avatar']); ?>" width="150" height="150"></a>

						</div>
						<?php else: ?>
						<div class="fight-invite－area">
							<span class="fight-invite"> <a
								href="<?php echo U('/fight/'.$fight['id']);?>">战</a></span>
				...
				<div class="fight-coins-area">
					<span class="fight-coins"> 金币：<?php echo ($fight["fight_coins"]); ?> </span>
				</div>


				<?php if($joins): ?><div class="column-content">
					<div class="column-content-title">
						<i class="title-tip-box"></i> <span class="title-tip"><a
							href="<?php echo U('/fight/join/list/'.$fight['id']);?>">参战人员</a></span> <span
							class="pull-right"> <a
							href="<?php echo U('/fight/join/list/'.$fight['id']);?>">更多参战</a>
						</span>
					</div>

					<div class="join-list">
						<ul>
							<?php if(is_array($joins)): $i = 0; $__LIST__ = $joins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$join): $mod = ($i % 2 );++$i;?><li>

								<div class="cl">
									<div class="avatar">

										<a href="<?php echo U('/u/'.$join['uid']);?>"> <img
											src="/Public/Core/images/placeholder.png"
											lazy-src="<?php echo ($join["user"]["avatar"]); ?>" width="80" height="80">
										</a>
									</div>
									<div class="fighter-info">

										<div>
											<a href="<?php echo U('/u/'.$join['uid']);?>"><?php echo ($join["user"]["username"]); ?></a>
										</div>

										<div class="pull-left">
											<div>赚取: <?php echo ($join["user"]["win_coins"]); ?></div>

											<div>场次: <?php echo ($join["user"]["total_fights"]); ?></div>
										</div>
				...
				<div class="comment">
					<!-- 多说评论框 start -->
					<div class="ds-thread" data-thread-key="video-<?php echo ($fight['id']); ?>"
						data-title="<?php echo ($fight['host']['username']); ?>"
						data-url="http://www.quntiao.com/fight/<?php echo ($fight["id"]); ?>.html"></div>
					<!-- 多说评论框 end -->
			...
			<div class="col-xs-3">
				<div>
						...
						<div class="row">
							...
							<div class="col-xs-1">
								<span class="glyphicon glyphicon-facetime-video  want-box-share-icon "></span>
							</div>
							<div class="col-xs-4">
					...
					<?php echo W('IndexFightRank/lists');?>
