...
<link href="/Public/Fight/css/listview.css" rel="stylesheet" />
</head>
<body>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="column-content">
							<div class="game-category-area">
								<ul>
									<?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$game): $mod = ($i % 2 );++$i;?><li <?php if($game['id'] == $gameid): ?>class="selected"<?php endif; ?>><a href="<?php echo U('/fight/list/'.$game['id']);?>"
										title="<?php echo ($game["title"]); ?>"><?php echo ($game["title"]); ?></a></li>
						...
						<div class="fight-list column-content">
							<ul>
								<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fight): $mod = ($i % 2 );++$i;?><li><?php $host =query_user(array('avatar','username'),$fight['host_uid']); $guest=query_user(array('avatar','username'),$fight['guest_uid']); ?>
									<div class="fight-info">

										<div class="fight-info-member">
											<a href="<?php echo U('/fight/'.$fight['id']);?>"><img
												src="/Public/Core/images/placeholder.png"
												lazy-src="<?php echo ($host['avatar']); ?>" width="69" height="69"></a>
										</div>
										<div class="fight-info-member vs">VS</div>
										<div class="fight-info-member">
											<?php if($fight['guest_uid'] < 0): ?><a
												href="<?php echo U('/fight/'.$fight['id']);?>"><img
												src="/Public/Core/images/placeholder.png"
												lazy-src="<?php echo ($guest['avatar']); ?>" width="69" height="69"></a>
									...
									<div class="fight-info-name">
										<div class="fight-member-name">
											<a href="<?php echo U('/fight/'.$fight['id']);?>"><?php echo ($host['username']); ?></a>
										</div>
										<div class="fight-member-name"></div>
										<div class="fight-member-name">

											<?php if($fight['guest']): ?><a
												href="<?php echo U('/fight/'.$fight['id']);?>"><?php echo ($guest['username']); ?></a><?php endif; ?>

										</div>

									</div>
									<div class="fight-des">
										<span class="fight-coin">金币: <?php echo ($fight['fight_coins']); ?></span> <span
											class="fight-game"><?php echo get_game($fight['game_id'],'title');?></span>
