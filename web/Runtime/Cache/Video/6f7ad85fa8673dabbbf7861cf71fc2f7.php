...
<a id="goTopBtn"></a>
	<div id="main-container" class="container">
		<div class="row">
						...
						<div class="game-category-area">
							<ul>
								<?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$game): $mod = ($i % 2 );++$i;?><li <?php if($game['id'] == $gameid): ?>class="selected"<?php endif; ?>><a  
									href="<?php echo U('/video/list/'.$game['id']);?>" title="<?php echo ($game["title"]); ?>"><?php echo ($game["title"]); ?></a></li>
					...
					<div class="col-xs-12  column-content">
						<div class="video-list">
							<ul>
								...
								<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?><li>
									...
									<div class="video-des"><a href="<?php echo U('/video/'.$video['id']);?>"><?php echo ($video["title"]); ?></a></div>
			...
			<?php echo W('ListHotVideo/newvideos',array($gameid));?>
