...
<link href="/Public/Home/css/game.css" rel="stylesheet" type="text/css" />
	...
	<div class="container">
		...
		<div>
			<ul class="nav navbar-nav " style="font-size: 16px">
				...
				<li><a href="<?php echo U('/lol/index');?>">英雄联盟</a></li>
...
<div class="row">
<div class='col-xs-12 sub-nav-head'>

<div class="sub-nav_title"><i
	class="sub-nav_ico_i glyphicon glyphicon-th-large"> </i><?php echo ($game['title']); ?>
</div>
<div>
<div class="aline"></div>
</div>
...
<ul id="top_nav" class="nav_list clearfix">
	...
	<li><a href="<?php echo U('index');?>">全部</a></li>

	<li><a href="<?php echo U('index');?>">在线直播</a></li>
	<li><a href="<?php echo U('index');?>">在线约战</a></li>
	<li><a href="<?php echo U('index');?>">最新比赛</a></li>

	<li><a href="<?php echo U('index');?>">最新视频</a></li>



	<li><a href="<?php echo U('index');?>">视频专辑</a></li>

	<li><a href="<?php echo U('index');?>">游戏战队</a></li>

	<li><a href="<?php echo U('index');?>">战绩排行榜</a></li>

	<li><a href="<?php echo U('index');?>">在线讨论</a></li>

	<li class="pull-right btn-submit">

	<button class="btn btn-primary "><i
		class="glyphicon glyphicon-fire"></i>&nbsp;我要约战</button>

	<button class="btn btn-primary "><i
		class="glyphicon glyphicon-send"></i>&nbsp;分享视频</button>
