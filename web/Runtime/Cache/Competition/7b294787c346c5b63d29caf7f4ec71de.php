		...
		<div class="row">
			...
			<div class="col-xs-9">
						...
						<span class="title-content"> <span class="match-name"><a
							...
							<span class="match-game-title"><h3>
									<a href="<?php echo U('/team/'.$matchgame['blue_team']);?>">
										<?php echo query_team('name',$matchgame['blue_team']);?> </a><b>vs</b> <a
				...
				<div class="vs-team-info">
					<div class="vs-blue-team">
						<ul>
							<?php if(is_array($bluemembers)): $i = 0; $__LIST__ = $bluemembers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bluemember): $mod = ($i % 2 );++$i;?><li><div>
									<a href="<?php echo U('/u/'.$bluemember['uid']);?>">	<img src="/Public/Core/images/placeholder.png"
					...
					<div class="vs-info">
						<div class="pre-vs-info">
							<div>
								<div class="preteamcon">
									<?php if($matchgame['blue_team']): ?><div>
										<a href="<?php echo U('/u/'.$redmember['uid']);?>">	<img src="/Public/Core/images/placeholder.png"
											width="120px" height="120px"
											lazy-src="<?php echo query_team('cover',$matchgame['blue_team']);?>"
											alt="$matchgame['blue_game']">
											</a>


										<div class="teamname"><?php echo query_team('name',$matchgame['blue_team']);?></div>
									</div>
									<?php else: ?>
									<div class="giveup">弃权</div><?php endif; ?>
								</div>
								<div class="prevstime">
									<div class="vsplaytime"><?php echo date('Y-m-d
										H:i',$matchgame['start_time']);?></div>
									<div class="vs-vs">VS</div>
									<div class="qq-alarm">
										<script type="text/javascript">
											var __qqClockShare = {
												content : "<?php echo query_team('name',$matchgame['blue_team']);?> VS <?php echo query_team('name',$matchgame['red_team']);?> 要开始了！",
												time : "<?php echo date('Y-m-d H:i',$matchgame['start_time']);?>",
												advance : 5,
												url : "http://www.quntiao.com<?php echo U('/matchgame/'.$matchgame['id']);?>",
												icon : "1_1"
											};
											document
													.write('<a  href="http://qzs.qq.com/snsapp/app/bee/widget/open.htm#content='
															+ encodeURIComponent(__qqClockShare.content)
															+ '&time='
															+ encodeURIComponent(__qqClockShare.time)
															+ '&advance='
															+ __qqClockShare.advance
															+ '&url='
															+ encodeURIComponent(__qqClockShare.url)
															+ '" target="_blank"><img src="http://i.gtimg.cn/snsapp/app/bee/widget/img/' + __qqClockShare.icon + '.png" style="border:0px;"/></a>');
										</script>
									</div>
								</div>
								<div class="preteamcon">

									<?php if($matchgame['red_team']): ?><div>
										<img src="/Public/Core/images/placeholder.png"
											width="120px" height="120px"
											lazy-src="<?php echo query_team('cover',$matchgame['red_team']);?>"
											alt="$matchgame['red_team']}">
										<div class="teamname">
											<span><?php echo query_team('name',$matchgame['red_team']);?></span>
										</div>
									</div>
									<?php else: ?>
									<div class="giveup">弃权</div><?php endif; ?>
						...
						<ul>
							<?php if(is_array($redmembers)): $i = 0; $__LIST__ = $redmembers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$redmember): $mod = ($i % 2 );++$i;?><li>
								<div>
									<img src="/Public/Core/images/placeholder.png"
										width="80px" height="80px"
										lazy-src="<?php echo query_user('avatar',$redmember['uid']);?>">
								</div>
					...
					<div class="col-xs-12  column-content">
						<div class="side-matchvideo-list">
							<ul>
								...
								<div class="v-thumb"><a href="<?php echo U('/video/'.$matchvideo['id']);?>">
								  <img
										...
										<div class="v-num"><span
							class="glyphicon glyphicon-facetime-video  "></span> <span
							class="game-des-online"><?php echo ($matchvideo['views']); ?></span></div>
										</div>
