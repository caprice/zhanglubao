...
<link href="/Public/Competition/css/view.css" rel="stylesheet" />
	...
	<div id="main-container" class="container">
		<div class="row">
			...
			<div class="col-xs-9">
				...
				<div class="vs-team-info">
						...
						<ul>
							<?php if(is_array($bluemembers)): $i = 0; $__LIST__ = $bluemembers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bluemember): $mod = ($i % 2 );++$i;?><li><div>
									<img src="/Public/Static/quntiao/image/placeholder.png"
										...
										lazy-src="<?php echo query_user('avatar',$bluemember['uid']);?>">
								</div>
					...
					<div class="vs-info">
						...
						src="<?php echo ($currentlive['flash_url']); ?>"
				...
				<div class="comment">
					<!-- 多说评论框 start -->
					<div class="ds-thread" data-thread-key="<?php echo ($matchgame['id']); ?>"
			...
			<div class="col-xs-3">
				...
				<div class="row">
					<div class="guess-win">
						<div class="guess-item">
							<span class="guess-item-win"><?php echo query_team('name',$matchgame['blue_team']);?>
								胜</span> <span class="guess-item-even">平</span> <span
								class="guess-item-win"><?php echo query_team('name',$matchgame['red_team']);?>
								胜</span>
						</div>
					</div>
				...
				<?php if($lives): ?><div class="row">
					<div class="col-xs-12  column-content">
						<div class="column-content-title">
							<i class="title-tip-box"></i> <span class="title-tip">其他视角</span> 
						</div>
					</div>
					<div class="col-xs-12  column-content">
								...
								<?php if(is_array($lives)): $i = 0; $__LIST__ = $lives;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$live): $mod = ($i % 2 );++$i;?><li>
									...
									<div class="v-meta">
										...
										<div class="v-meta-title">
											<a href="<?php echo U('/live/'.$live['id']);?>"><?php echo ($live['title']); ?></a>

										</div>

										<div class="v-num">
											<span class="glyphicon glyphicon-facetime-video  "></span> <span
												class="game-des-online"><?php echo ($live['views']); ?></span>
										</div>
									</div>
