			...
			<div class="main-box-body clearfix">
				<form class="form-horizontal" action="<?php echo U();?>" method="post">
					...
					<input type="hidden" name="game_id" value="7" /> <input
						...
						type="hidden" name="id" value="<?php echo ($doc["id"]); ?>" />
					<div class="form-group">
						<label for="inputTitle" class="col-lg-1 control-label">文章名称</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="inputTitle"
								value="<?php echo ($doc["title"]); ?>" name="title" placeholder="文章名称">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-11">
							<input type="text" id="articleTags" name="tags"
								value="<?php echo ($doc["tags"]); ?>" placeholder="文章标签">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-11">
							<textarea class="form-control" name="description"
								id="articledescription" rows="4"><?php echo ($doc["description"]); ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-11">
							<input type="file" id="upload_file_image"> <input
								type="hidden" name="cover_id" value="<?php echo ($doc['cover_id']); ?>" />
							<div class="upload-img-box">
								<?php if(!empty($doc['cover_id'])): ?><div class="upload-pre-item">
									<img src="<?php echo (get_article_cover($doc['cover_id'],'url')); ?>" />
								</div><?php endif; ?>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-11">
							<textarea name="content" id="articleContetnt"><?php echo ($article["content"]); ?></textarea>
				...
				.uploadify(
						{
							...
							"buttonText" : "上传附件",
							"uploader" : "<?php echo U('DcPicture/uploadCoverPicture',array('session_id'=>session_id()));?>",
							"width" : 120,
							'removeTimeout' : 1,
...
<link rel="stylesheet"
	href="/Public/Static/js/kindeditor/default/default.css" />
<script charset="utf-8"
	src="/Public/Static/js/kindeditor/kindeditor-min.js"></script> <script
	charset="utf-8" src="/Public/Static/js/kindeditor/zh_CN.js"></script> <script
	type="text/javascript">
		...
		KindEditor.ready(function(K) {
			editor_content = K.create('textarea[name="content"]', {
				...
				uploadJson : "<?php echo U('DcPicture/uploadArticlePicture');?>",
