			...
			<header class="main-box-header clearfix">
				...
				<div class="filter-block pull-right">
					<div class="form-group pull-left search-form">
						<input type="text"  name="category_name"  class="form-control search-input" placeholder="文章名称..." value="<?php echo I('category_name');?>">
						<i class="fa fa-search search-icon" id="search" url="<?php echo U('index');?>"></i>
					</div>
					<a href="<?php echo U('/Article/DcArticle/add');?>" class="btn btn-primary pull-right">
						<i class="fa fa-plus-circle fa-lg"></i> 添加文章
					</a>
				</div>
			</header>
						...
						<tbody>
							<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td style="width: 15%;"><?php if(($vo["status"]) == "1"): ?><a
										href="<?php echo U('Article/DcArticle/changeStatus?method=forbid&id='.$vo['id']);?>"
										...
										href="<?php echo U('Article/DcArticle/changeStatus?method=resume&id='.$vo['id']);?>"
										class="ajax-get table-link"><span class="fa-stack">
											<i class="fa fa-square fa-stack-2x"></i> <i
											class="fa  fa-check-circle-o fa-stack-1x fa-inverse"></i>
									</span></a><?php endif; ?> <a href="<?php echo U('Article/DcArticle/edit?id='.$vo['id']);?>"
									class="table-link"> <span class="fa-stack"> <i
											class="fa fa-square fa-stack-2x"></i> <i
											class="fa fa-pencil fa-stack-1x fa-inverse"></i>
									</span>
								</a> <a
									href="<?php echo U('Article/DcArticle/changeStatus?method=delete&id='.$vo['id']);?>"
