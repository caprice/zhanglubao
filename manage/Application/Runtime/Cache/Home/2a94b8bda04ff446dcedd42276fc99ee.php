...
<div class="row">
	<div class="col-lg-3 col-sm-6 col-xs-12">
		<div class="main-box infographic-box">
			...
			<span class="value"><?php echo ($videocount); ?></span>
		</div>
	</div>
	<div class="col-lg-3 col-sm-6 col-xs-12">
		<div class="main-box infographic-box">
			<i class="fa fa-user emerald-bg"></i> <span class="headline">游戏明星</span>
			<span class="value"><?php echo ($verifycount); ?></span>
		</div>
	</div>
	<div class="col-lg-3 col-sm-6 col-xs-12">
		<div class="main-box infographic-box">
			<i class="fa fa-list green-bg"></i> <span class="headline">视频专辑</span>
			<span class="value"><?php echo ($albumcount); ?></span>
		</div>
	</div>
	<div class="col-lg-3 col-sm-6 col-xs-12">
		<div class="main-box infographic-box">
						...
						<div class="graph-legend-row col-md-12 col-sm-4">
							<div class="graph-legend-row-inner">
								<span class="graph-legend-name"> 视频数目 </span> <span
									class="graph-legend-value"> <?php echo ($videocount); ?> </span>
							</div>
						</div>
						<div class="graph-legend-row col-md-12 col-sm-4">
							<div class="graph-legend-row-inner">
								<span class="graph-legend-name"> 用户数目 </span> <span
									class="graph-legend-value"> <?php echo ($usercount); ?> </span>
							</div>
						</div>
						<div class="graph-legend-row col-md-12 col-sm-4">
							<div class="graph-legend-row-inner">
								<span class="graph-legend-name"> 视频专辑 </span> <span
									class="graph-legend-value"> <?php echo ($albumcount); ?> </span>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="main-box clearfix">
			<header class="main-box-header clearfix">
				...
				<div class="form-group pull-left search-form">
						<input type="text"  name="video_title"  class="form-control search-input" placeholder="关键字..." value="<?php echo I('video_title');?>">
						<i class="fa fa-search search-icon" id="search" url="<?php echo U('Video/Video/index');?>"></i>
					</div>
					<a href="<?php echo U('Video/Video/index');?>" class="btn btn-primary pull-right"> <i
			...
			<div class="main-box-body clearfix">
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							<?php if(!empty($_videolist)): if(is_array($_videolist)): $i = 0; $__LIST__ = $_videolist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td style="width: 15%;"><?php if(($vo["status"]) == "1"): ?><a
										href="<?php echo U('Video/Video/changeStatus?method=forbid&id='.$vo['id']);?>"
										...
										href="<?php echo U('Video/Video/changeStatus?method=resume&id='.$vo['id']);?>"
										class="ajax-get table-link"><span class="fa-stack">
											<i class="fa fa-square fa-stack-2x"></i> <i
											class="fa  fa-check-circle-o fa-stack-1x fa-inverse"></i>
									</span></a><?php endif; ?> <a href="<?php echo U('Video/Video/edit?id='.$vo['id']);?>"
									class="table-link"> <span class="fa-stack"> <i
											class="fa fa-square fa-stack-2x"></i> <i
											class="fa fa-pencil fa-stack-1x fa-inverse"></i>
									</span>
								</a> <a
									href="<?php echo U('Video/Video/changeStatus?method=delete&id='.$vo['id']);?>"
