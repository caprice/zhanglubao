						...
						<div class="collapse navbar-collapse navbar-ex1-collapse"
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li id="MenuWeb"><a href="#" class="dropdown-toggle"> <i
									...
									<ul class="submenu">
										<li id="MenuSubFriendLink"><a
											href="<?php echo U('Article/Article/index');?>"> 文章管理 </a></li>
										<li id="MenuSubFriendLink"><a
											href="<?php echo U('Article/Category/index');?>"> 文章分类 </a></li>
									</ul></li>
				...
				<div class="filter-block pull-right">
					<div class="form-group pull-left search-form">
						<input type="text" name="question_title"
							...
							value="<?php echo I('video_title');?>"> <i
							class="fa fa-search search-icon" id="search" url="<?php echo U('index');?>"></i>
					</div>
					<a href="<?php echo U('/Question/Question/add');?>"
						class="btn btn-primary pull-right"> <i
						class="fa fa-plus-circle fa-lg"></i> 添加问题
					</a>
				</div>
			</header>
					...
					<table class="table">
						...
						<tbody>
							<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td><?php echo ($vo["question_id"]); ?></td>
								<td><?php echo ($vo["question_title"]); ?></td>
								<td class="text-center"><?php if($vo['status'] == 0 ): ?><span class="label label-warning">禁用</span> <?php else: ?> <span
										class="label label-success">启用</span><?php endif; ?></td>
								<td class="text-center"><?php echo date('Y-m-d
									H:i:s',$vo['create_time']);?></td>
								<td style="width: 15%;"><?php if(($vo["status"]) == "1"): ?><a
										href="<?php echo U('Question/Question/changeStatus?method=forbid&id='.$vo['question_id']);?>"
										...
										href="<?php echo U('Question/Question/changeStatus?method=resume&id='.$vo['question_id']);?>"
										class="ajax-get table-link"><span class="fa-stack">
											<i class="fa fa-square fa-stack-2x"></i> <i
											class="fa  fa-check-circle-o fa-stack-1x fa-inverse"></i>
									</span></a><?php endif; ?> <a href="<?php echo U('Question/Question/edit?id='.$vo['question_id']);?>"
									class="table-link"> <span class="fa-stack"> <i
											class="fa fa-square fa-stack-2x"></i> <i
											class="fa fa-pencil fa-stack-1x fa-inverse"></i>
									</span>
								</a> <a
									href="<?php echo U('Question/Question/changeStatus?method=delete&id='.$vo['question_id']);?>"
