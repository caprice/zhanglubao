...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="main-box clearfix" style="min-height: 1180px;">
			<header class="main-box-header clearfix">
				<h2><?php echo isset($info['id'])?'编辑':'新增';?>广告</h2>
			</header>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							  <select name="type" class="form-control">
								...
								<option value='1' <?php if(($info["type"]) == "1"): ?>selected<?php endif; ?>>视频</option>
								<option value='2' <?php if(($info["type"]) == "2"): ?>selected<?php endif; ?>>新闻</option>
								<option value='3' <?php if(($info["type"]) == "3"): ?>selected<?php endif; ?>>知道</option>
								<option value='4' <?php if(($info["type"]) == "4"): ?>selected<?php endif; ?>>比赛</option>
								<option value='5' <?php if(($info["type"]) == "5"): ?>selected<?php endif; ?>>网页</option>
								<option value='6' <?php if(($info["type"]) == "6"): ?>selected<?php endif; ?>>下载</option>
								<option value='7' <?php if(($info["type"]) == "7"): ?>selected<?php endif; ?>>其他</option>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" id="inputUrl" name="url"
								placeholder="跳转地址" value="<?php echo ((isset($info['url']) && ($info['url'] !== ""))?($info['url']):''); ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" id="inputValueId"
								...
								value="<?php echo ((isset($info['value_id']) && ($info['value_id'] !== ""))?($info['value_id']):'0'); ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="file" id="upload_picture"> <input id="cover_id"
								type="hidden" name="cover_id" value="<?php echo ($info['cover_id']); ?>" />
							<div class="upload-img-box">
								<?php if(!empty($info['cover_id'])): ?><div class="upload-pre-item">
									<img src="<?php echo (get_slide_cover($info['cover_id'],'url')); ?>" />
								</div><?php endif; ?>
							</div>
						</div>
					</div>
	...
	src="/Public/Static/js/uploadify/jquery.uploadify.min.js"></script> <script
				...
				.uploadify(
						{
							...
							"buttonText" : "上传图片",
							"uploader" : "<?php echo U('App/File/uploadPicture',array('session_id'=>session_id()));?>",
							"width" : 120,
							'removeTimeout' : 1,
