	...
	<div class="col-lg-12">
		<div class="main-box clearfix">
			<header class="main-box-header clearfix">
				<h2 class="pull-left">Seo列表</h2>
				<div class="filter-block pull-right">
					<div class="form-group pull-left search-form">
						<input type="text"  name="title"  class="form-control search-input" placeholder="标题..." value="<?php echo I('title');?>">
						<i class="fa fa-search search-icon" id="search" url="<?php echo U('index');?>"></i>
					</div>
					<a href="<?php echo U('/System/Seo/add');?>" class="btn btn-primary pull-right">
						<i class="fa fa-plus-circle fa-lg"></i> 添加配置
					</a>
				</div>
			</header>
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th class="text-left"><span>模块</span></th>
								<th class="text-left"><span>控制器</span></th>
								<th class="text-left"><span>方法</span></th>
						...
						<tbody>
							<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td style="width: 15%;"><?php if(($vo["status"]) == "1"): ?><a
										href="<?php echo U('System/Seo/changeStatus?method=forbid&id='.$vo['id']);?>"
										...
										href="<?php echo U('System/Seo/changeStatus?method=resume&id='.$vo['id']);?>"
										class="ajax-get table-link"><span class="fa-stack">
											<i class="fa fa-square fa-stack-2x"></i> <i
											class="fa  fa-check-circle-o fa-stack-1x fa-inverse"></i>
									</span></a><?php endif; ?> <a href="<?php echo U('System/Seo/edit?id='.$vo['id']);?>"
									class="table-link"> <span class="fa-stack"> <i
											class="fa fa-square fa-stack-2x"></i> <i
											class="fa fa-pencil fa-stack-1x fa-inverse"></i>
									</span>
								</a> <a
									href="<?php echo U('System/Seo/changeStatus?method=delete&id='.$vo['id']);?>"
